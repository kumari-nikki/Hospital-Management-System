...
//Helper functions
// this  function will provide infinite number
const safeNumber = (v) => {
    const n = Number(v);
...
//this function will get the user from clerk and return the user details here
...
export const confirmPayment = async (req, res) => {
    try {
        ...
        try {
            ...
            return res.status(404).json({
                success: false,
                message: "Stripe session is not found over",
            });
        }
...
export const updateAppointment = async (req, res) => {
    try {
        ...
        const updated = await Appointment.findByIdAndUpdate(id, update,
            ...
            path: "doctorId", select: "name imageUrl"
        }).lean();
...
export default {
    getAppointments, getAppointmentsByPatient, createAppointment,
    confirmPayment,
    updateAppointment,
    cancelAppointment,
    getStats,
