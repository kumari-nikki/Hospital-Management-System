...
// to check previous date comes first that is latest upcoming date coming first here
...
export default function ServiceAppointmentsPage() {
  ...
  // (to update the status) change status -> PUT /api/service-appointments/:id with { status }
  ...
  // to reschedule the appointment for later but not on previous days -> PUT /api/service-appointments/:id with { rescheduledTo: { date, time }, status: "Rescheduled" }
  ...
  //to cancel any appointment -> POST /api/service-appointments/:id/cancel
