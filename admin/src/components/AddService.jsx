...
export default function AddService({ apiBase, serviceId }) {
  ...
  // user can not select previous year/month /date  from today
  useEffect(() => {
  ...
  // to prevent user for selecting the past time for particular date
  ...
  // to validate all the fields are filled by user or not
  function validate() {
    const newErrors = {};
