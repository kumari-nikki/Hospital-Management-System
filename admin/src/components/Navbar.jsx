...
const Navbar = () => {
    ...
    //it will be toggling the mobile menu ie:when we close the escape button here
    useEffect(() => {
        const onKey = (e) => {
    ...
    //when user signed in, fetch a token and save it in the local sorage
    useEffect(() => {
        let mounted = true;
