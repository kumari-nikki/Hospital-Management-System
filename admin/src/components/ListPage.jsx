...
// this function will give u output as DD-MM-YYYY;
...
//this function will normalize schedule map:ex- YYYY-MM-DD:[slot1,slote2.....]
 ...
 * - past dates first, nearest past → older past(means tommorow will come on top)
...
export default function ListPage({ apiBase }) {
    ...
    // to filter the available doctor
    ...
    //show all the doctor according to filter
    ...
    // to delete any doctor (calls backend)
    ...
    // show all the doctor or the filtered ones
