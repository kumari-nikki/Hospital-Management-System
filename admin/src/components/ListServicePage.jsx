...
function sortSlotsForDisplay(slots = []) {
  ...
  // function convert Map-like slots (object or Map) to array-of-slot-objects
...
// to validate the slot is not of previous days
  ...
  // When changing file in edit form, store both preview AND file- for image handling
